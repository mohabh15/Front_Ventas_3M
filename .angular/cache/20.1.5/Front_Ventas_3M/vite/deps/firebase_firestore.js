...
var __PRIVATE_SimpleDb = class ___PRIVATE_SimpleDb {
  ...
  L(e) {
    return __async(this, null, function* () {
      return this.db || (__PRIVATE_logDebug(W, "Opening database:", this.name), this.db = yield new Promise((t, n) => {
...
var __PRIVATE_IndexBackfillerScheduler = class {
  ...
  re(e) {
    __PRIVATE_logDebug(z, `Scheduled in ${e}ms`), this.task = this.asyncQueue.enqueueAfterDelay("index_backfill", e, () => __async(this, null, function* () {
      this.task = null;
      try {
        const e2 = yield this.ne.ie();
        __PRIVATE_logDebug(z, `Documents written: ${e2}`);
      } catch (e2) {
        __PRIVATE_isIndexedDbTransactionError(e2) ? __PRIVATE_logDebug(z, "Ignoring IndexedDB error during index backfill: ", e2) : yield __PRIVATE_ignoreIfPrimaryLeaseLoss(e2);
      }
      yield this.re(6e4);
    }));
  }
...
var __PRIVATE_LruScheduler = class {
  ...
  Vr(e) {
    __PRIVATE_logDebug(Nt, `Garbage collection scheduled in ${e}ms`), this.Rr = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", e, () => __async(this, null, function* () {
      this.Rr = null;
      try {
        yield this.localStore.collectGarbage(this.garbageCollector);
      } catch (e2) {
        __PRIVATE_isIndexedDbTransactionError(e2) ? __PRIVATE_logDebug(Nt, "Ignoring IndexedDB error during garbage collection: ", e2) : yield __PRIVATE_ignoreIfPrimaryLeaseLoss(e2);
      }
      yield this.Vr(3e5);
    }));
  }
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  ...
  setDatabaseDeletedListener(e) {
    this.Ui.$((t) => __async(this, null, function* () {
  ...
  setNetworkEnabled(e) {
    ...
    this.Mi.enqueueAndForget(() => __async(this, null, function* () {
  ...
  shutdown() {
    return __async(this, null, function* () {
      ...
      yield this.Ui.runTransaction("shutdown", "readwrite", [Y, we], (e) => {
...
var __PRIVATE_WebStorageSharedClientState = class {
  ...
  start() {
    return __async(this, null, function* () {
      const e = yield this.syncEngine.Ts();
      for (const t2 of e) {
  ...
  Ys(e) {
    ...
    if (t.storageArea === this.storage) {
      ...
      this.Mi.enqueueRetryable(() => __async(this, null, function* () {
        if (this.started) {
          if (null !== t.key) {
            if (this.ro.test(t.key)) {
              ...
              yield Promise.all(e2.map((e3) => this.syncEngine.Do(e3)));
            }
          }
        } else this.Xs.push(t);
      }));
  ...
  constructor(e, t, n, r, i) {
    ...
    this.da = [], this.Aa = i, this.Aa.Oo((e2) => {
      n.enqueueAndForget(() => __async(this, null, function* () {
        __PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug(tn, "Restarting streams for network reachability change."), yield function __PRIVATE_restartNetwork(e3) {
          return __async(this, null, function* () {
            const t2 = __PRIVATE_debugCast(e3);
            t2.Ea.add(
              4
              /* OfflineCause.ConnectivityChange */
            ), yield __PRIVATE_disableNetworkInternal(t2), t2.Ra.set(
              "Unknown"
              /* OnlineState.Unknown */
            ), t2.Ea.delete(
              4
  ...
  return __async(this, null, function* () {
    if (
        ...
        yield function __PRIVATE_handleTargetError(e2, t2) {
          return __async(this, null, function* () {
            ...
            for (const r of t2.targetIds)
              e2.Ia.has(r) && (yield e2.remoteSyncer.rejectListen(r, n2), e2.Ia.delete(r), e2.Va.removeTarget(r));
          });
        }(e, t);
      } catch (n2) {
        __PRIVATE_logDebug(tn, "Failed to remove targets %s: %s ", t.targetIds.join(","), n2), yield __PRIVATE_disableNetworkUntilRecovery(e, n2);
      }
      ...
      */
      ...
      __PRIVATE_logDebug(tn, "Failed to raise snapshot:", t2), yield __PRIVATE_disableNetworkUntilRecovery(e, t2);
    }
  });
}
function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  return __async(this, null, function* () {
    ...
    yield __PRIVATE_disableNetworkInternal(e), e.Ra.set(
      "Offline"
      /* OnlineState.Offline */
    ...
    e.asyncQueue.enqueueRetryable(() => __async(null, null, function* () {
      __PRIVATE_logDebug(tn, "Retrying IndexedDB access"), yield n(), e.Ea.delete(
        1
        /* OfflineCause.IndexedDbFailed */
...
function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
  return __async(this, null, function* () {
    ...
    n.Ra.set(
      "Unknown"
      /* OnlineState.Unknown */
    ), yield n.remoteSyncer.handleCredentialChange(t), n.Ea.delete(
      3
      /* OfflineCause.CredentialChange */
...
function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
  return __async(this, null, function* () {
    ...
    ), yield __PRIVATE_enableNetworkInternal(n)) : t || (n.Ea.add(
      2
      /* OfflineCause.IsSecondary */
    ), yield __PRIVATE_disableNetworkInternal(n), n.Ra.set(
      "Unknown"
      /* OnlineState.Unknown */
    ));
  });
...
function __PRIVATE_ensureWriteStream(e) {
  ...
  (e.fa = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    ...
    yield __PRIVATE_fillWritePipeline(e)) : (yield e.fa.stop(), e.Ta.length > 0 && (__PRIVATE_logDebug(tn, `Stopping write stream with ${e.Ta.length} pending writes`), e.Ta = []));
  }))), e.fa;
}
...
var __PRIVATE_BundleLoader = class {
  ...
  ja(e) {
    return __async(this, null, function* () {
      const t = yield __PRIVATE_localStoreApplyBundledDocuments(e, new __PRIVATE_BundleConverterImpl(this.serializer), this.Wa, this.Ua.id), n = this.za(this.documents);
      for (const t2 of this.Ka) yield __PRIVATE_localStoreSaveNamedQuery(e, t2, n.get(t2.name));
  ...
  $u(e) {
    return __async(this, null, function* () {
      for (; this.buffer.length < e; ) {
        (yield this.Ku()) && this.Qu("Reached the end of bundle when more is expected.");
      }
    ...
    return __async(this, null, function* () {
      ...
      const t = yield function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
        return __async(this, null, function* () {
          ...
          }, i = yield n.Ho("BatchGetDocuments", n.serializer.databaseId, ResourcePath.emptyPath(), r, t2.length), s = /* @__PURE__ */ new Map();
          i.forEach((e3) => {
    ...
    return __async(this, null, function* () {
      ...
      e.forEach((e2, t) => {
        ...
        return __async(this, null, function* () {
          ...
          yield n.Go("Commit", n.serializer.databaseId, ResourcePath.emptyPath(), r);
        });
...
var FirestoreClient = class {
  constructor(e, t, n, r, i) {
    this.authCredentials = e, this.appCheckCredentials = t, this.asyncQueue = n, this.databaseInfo = r, this.user = User.UNAUTHENTICATED, this.clientId = __PRIVATE_AutoId.newId(), this.authCredentialListener = () => Promise.resolve(), this.appCheckCredentialListener = () => Promise.resolve(), this._uninitializedComponentsProvider = i, this.authCredentials.start(n, (e2) => __async(this, null, function* () {
      __PRIVATE_logDebug(on, "Received user=", e2.uid), yield this.authCredentialListener(e2), this.user = e2;
...
function __PRIVATE_setOnlineComponentProvider(e, t) {
  return __async(this, null, function* () {
    ...
    __PRIVATE_logDebug(on, "Initializing OnlineComponentProvider"), yield t.initialize(n, e.configuration), // The CredentialChangeListener of the online component provider takes
...
function __PRIVATE_ensureOfflineComponents(e) {
  return __async(this, null, function* () {
    ...
    } else __PRIVATE_logDebug(on, "Using default OfflineComponentProvider"), yield __PRIVATE_setOfflineComponentProvider(e, new __PRIVATE_LruGcMemoryOfflineComponentProvider(void 0));
    return e._offlineComponents;
  });
}
function __PRIVATE_ensureOnlineComponents(e) {
  return __async(this, null, function* () {
    return e._onlineComponents || (e._uninitializedComponentsProvider ? (__PRIVATE_logDebug(on, "Using user provided OnlineComponentProvider"), yield __PRIVATE_setOnlineComponentProvider(e, e._uninitializedComponentsProvider._online)) : (__PRIVATE_logDebug(on, "Using default OnlineComponentProvider"), yield __PRIVATE_setOnlineComponentProvider(e, new OnlineComponentProvider()))), e._onlineComponents;
  });
}
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(() => __async(null, null, function* () {
    ...
    n.Nu(), e.asyncQueue.enqueueAndForget(() => __async(null, null, function* () {
...
var __PRIVATE_AsyncQueueImpl = class {
  ...
  lc() {
    return __async(this, null, function* () {
      if (0 !== this.Xu.length) {
        try {
          yield this.Xu[0](), this.Xu.shift(), this.M_.reset();
        } catch (e) {
...
function onSnapshot(e, ...t) {
  ...
  return function __PRIVATE_firestoreClientListen(e2, t2, n2, r2) {
    ...
    return e2.asyncQueue.enqueueAndForget(() => __async(null, null, function* () {
      ...
      i2.Nu(), e2.asyncQueue.enqueueAndForget(() => __async(null, null, function* () {
...
function runTransaction(e, t, n) {
  ...
  const r = __spreadValues(__spreadValues({}, In), n);
